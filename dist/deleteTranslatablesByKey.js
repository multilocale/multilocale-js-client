...
// src/deleteTranslatablesByKey.mjs
var deleteTranslatablesByKey_exports = {};
__export(deleteTranslatablesByKey_exports, {
  default: () => deleteTranslatablesByKey
});
module.exports = __toCommonJS(deleteTranslatablesByKey_exports);
var import_checkStringNotEmpty = __toESM(require("@multilocale/check/checkStringNotEmpty.mjs"), 1);
...
// src/failureIgnoreNotFoundOrNotModified.mjs
function failureIgnoreNotFoundOrNotModified(error) {
...
// src/delete_.mjs
function delete_default(config, customFailure) {
...
// src/deleteTranslatablesByKey.mjs
function deleteTranslatablesByKey(key) {
  (0, import_checkStringNotEmpty.default)(key);
  let url = `translatables?key=${key}`;
  return delete_default({ url }).catch((error) => {
