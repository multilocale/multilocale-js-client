...
// src/addTranslatables.mjs
var addTranslatables_exports = {};
__export(addTranslatables_exports, {
  default: () => addTranslatables
});
module.exports = __toCommonJS(addTranslatables_exports);
...
// src/post.mjs
function post(config, customFailure) {
  config.method = "POST";
  return http(config, customFailure);
}

// src/addTranslatables.mjs
function addTranslatables(translatables) {
